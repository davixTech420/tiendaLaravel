    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                <a href="{{ route('pdfCALI') }}"><i class="fas fa-file-pdf"> </i></a>                            
                                ...
                                <tbody>
                                    @foreach ($calificacions as $calificacion)
                                        <tr>
                                            ...
                                            <td>  <img src="{{  asset($calificacion->producto->imagen)   }}" alt="" width="120px"> </td>
                                            ...
                                            <td>
                                                <form action="{{ route('calificacion.destroy',$calificacion->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-success" href="{{ route('calificacion.edit',$calificacion->id) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
                ...
                {!! $calificacions->links('pagination::bootstrap-4') !!}
            </div>
        </div>
    </div>
@endsection
